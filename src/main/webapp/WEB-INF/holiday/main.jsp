...
<div id="bodyDiv">
    ...
    <div id="departmentDialog">
        <div id="departmentDialogContent">
            ...
            <div id="inputDepartment">
                ...
                <input type="button" id="chooseDepartmentLeaderButton"><input type="text" id="inputDepartmentLeaderName" readonly="readonly"><br/><br/>
    ...
    <div id="mineDialog">
        ...
        <div id="mineVacationInfo">
            <table id="mineVacationInfoTable">
